...
CREATE TABLE "new_Hotel" (
    ...
    "lowestRates" TEXT NOT NULL,
    "amenities" TEXT NOT NULL,
    "dining" TEXT NOT NULL,
    "roomTypes" TEXT NOT NULL,
    "image" TEXT NOT NULL DEFAULT ''
);
INSERT INTO "new_Hotel" ("description", "id", "image", "location", "name", "numberOfRooms", "price", "website") SELECT "description", "id", "image", "location", "name", "numberOfRooms", "price", "website" FROM "Hotel";
DROP TABLE "Hotel";
